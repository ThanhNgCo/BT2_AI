...
// Định nghĩa tường cố định: grid[x][y], x=cột (0..9), y=hàng (0..7)
var walls = [
    // Hàng ngang trên (y=1): x=1..5
    {x:1,y:1},{x:2,y:1},{x:3,y:1},{x:4,y:1},{x:5,y:1},
    // Nối phải + chặn giữa (y=2)
    {x:4,y:2},{x:5,y:2},{x:6,y:2},{x:7,y:2},
    // Cột phải tiếp (y=3)
    {x:7,y:3},
    // Hàng ngang dưới (y=4): x=3..7
...
// Điểm xuất phát và đích cố định
var source      = {x: 0, y: 3};
...
// Lưu trạng thái màu từng ô để vẽ lại mỗi frame
var cellColors = [];
